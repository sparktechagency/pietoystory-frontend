...
const Navbar: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const res = await axiosPublic.get<UserProfileApiResponse>(
          `/profile`,
          config
        );
  ...
  return (
    <div className=" bg-[#f6f6f6] ">
      <div className="max-w-[1519px] mx-auto flex gap-x-4 items-center justify-between py-2 lg:px-0 px-4">
        ...
        <div className="hidden lg:block w-2/4 mx-auto">
          <nav className="flex justify-between px-16 items-center bg-[#b9ecff] h-16 rounded-full font-degular font-medium text-xl">
            ...
            {profileData && <NavLink to="/refer">Referrals</NavLink>}
          </nav>
        </div>
            ...
            {accountOpen && (
              ...
              >
                <div>
                  <Link
                    to="/profile"
                    className=" font-degular border border-white py-[14px] px-6 rounded-[20px] shadow-md flex flex-row gap-x-[13px] items-center  "
                  >
                    <span>
                      <svg
                        width="20"
                ...
                <div className=" ">
                  <Link
                    to="/change-password"
                    className=" font-degular border border-white py-[14px] px-6 rounded-[20px] shadow-md flex flex-row gap-x-[13px] items-center my-4   "
                  >
                    <span>
                      <svg
                        width="22"
                      ...
                      >
                        <path
                          d="M20 4.5H11.65C11.2381 3.33048 10.4733 2.31762 9.46134 1.60116C8.44934 0.884703 7.23994 0.499954 6 0.5C2.69 0.5 0 3.19 0 6.5C0 9.81 2.69 12.5 6 12.5C7.23994 12.5 8.44934 12.1153 9.46134 11.3988C10.4733 10.6824 11.2381 9.66952 11.65 8.5H12L14 10.5L16 8.5L18 10.5L22 6.46L20 4.5ZM6 9.5C4.35 9.5 3 8.15 3 6.5C3 4.85 4.35 3.5 6 3.5C7.65 3.5 9 4.85 9 6.5C9 8.15 7.65 9.5 6 9.5Z"
                          fill="white"
                        />
                      </svg>
                    </span>
                ...
                <div>
                  ...
                  >
                    <span>
                      ...
                      >
                        <path
                          d="M6.1233 8.56078H5.41676C4.45259 8.52665 3.49155 8.68696 2.59327 9.03176C1.69499 9.37657 0.87865 9.89851 0.194906 10.5652L0 10.7879V17.3738H3.3134V13.6355L3.76006 13.1423L3.96309 12.9116C5.02039 11.8478 6.3367 11.0649 7.78812 10.6368C7.0617 10.095 6.48864 9.38037 6.1233 8.56078Z"
                          fill="white"
                        />
                        <path
                          d="M21.8295 10.5414C21.1457 9.87467 20.3294 9.35273 19.4311 9.00793C18.5328 8.66312 17.5718 8.50281 16.6076 8.53694C16.3119 8.53849 16.0165 8.55442 15.7224 8.58466C15.3503 9.35357 14.7928 10.0224 14.0982 10.5334C15.6478 10.9529 17.0516 11.7778 18.1587 12.9196L18.3618 13.1423L18.8003 13.6355V17.3818H22V10.7641L21.8295 10.5414Z"
                          fill="white"
                        />
                        <path
                          d="M5.39238 7.00973H5.64413C5.52716 6.02601 5.70339 5.03016 6.15156 4.14238C6.59973 3.25459 7.30068 2.51284 8.16979 2.00664C7.85474 1.53525 7.4201 1.15207 6.90843 0.894628C6.39675 0.637188 5.82558 0.514312 5.25085 0.538034C4.67613 0.561755 4.11754 0.731261 3.62979 1.02995C3.14205 1.32864 2.74186 1.74628 2.46843 2.24196C2.19499 2.73765 2.05768 3.29439 2.06994 3.85767C2.08219 4.42095 2.2436 4.97145 2.53835 5.45528C2.8331 5.9391 3.25109 6.33966 3.75139 6.61773C4.25168 6.89579 4.81714 7.04183 5.39238 7.04155V7.00973Z"
                          fill="white"
                        />
                        <path
                          d="M16.2178 6.41319C16.227 6.59602 16.227 6.77918 16.2178 6.96202C16.3736 6.98646 16.531 6.99975 16.6888 7.00179H16.8431C17.4158 6.97188 17.9708 6.79723 18.4542 6.49486C18.9375 6.19249 19.3327 5.77269 19.6012 5.27633C19.8697 4.77997 20.0025 4.22398 19.9865 3.66247C19.9705 3.10096 19.8063 2.55308 19.5099 2.07216C19.2136 1.59124 18.7951 1.19367 18.2953 0.918164C17.7955 0.642657 17.2314 0.498597 16.6579 0.50001C16.0843 0.501423 15.521 0.648261 15.0226 0.926228C14.5242 1.20419 14.1078 1.60382 13.8139 2.08619C14.5489 2.55622 15.1533 3.19761 15.5729 3.95282C15.9924 4.70803 16.214 5.55343 16.2178 6.41319Z"
                          fill="white"
                        />
                        <path
                          d="M10.8904 9.97658C12.8952 9.97658 14.5205 8.38475 14.5205 6.42113C14.5205 4.45751 12.8952 2.86567 10.8904 2.86567C8.88551 2.86567 7.26025 4.45751 7.26025 6.42113C7.26025 8.38475 8.88551 9.97658 10.8904 9.97658Z"
                          fill="white"
                        />
                        <path
                          d="M11.0853 11.8696C10.0247 11.8282 8.96659 11.997 7.97435 12.3661C6.98212 12.7351 6.07626 13.2967 5.31117 14.0172L5.10814 14.2399V19.2748C5.11131 19.4389 5.14744 19.6006 5.21446 19.751C5.28148 19.9013 5.37808 20.0372 5.49874 20.1509C5.61941 20.2647 5.76177 20.3541 5.9177 20.4139C6.07363 20.4738 6.24007 20.5029 6.40752 20.4998H15.7386C15.9061 20.5029 16.0725 20.4738 16.2285 20.4139C16.3844 20.3541 16.5267 20.2647 16.6474 20.1509C16.7681 20.0372 16.8647 19.9013 16.9317 19.751C16.9987 19.6006 17.0348 19.4389 17.038 19.2748V14.2559L16.8431 14.0172C16.0832 13.2941 15.1806 12.7307 14.1905 12.3614C13.2004 11.9921 12.1437 11.8248 11.0853 11.8696Z"
                          fill="white"
                        />
                      </svg>
                    </span>
      ...
      >
        <nav className="flex flex-col gap-y-4 font-degular text-[15px]">
          ...
          >
            ...
            <span className="font-degular text-black text-base">
              Create account
            </span>
          </Link>
        </nav>
